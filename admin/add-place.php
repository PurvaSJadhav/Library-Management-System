      ...
      <div class="container-fluid">
        ...
        <ol class="breadcrumb" style="background-color: #ebd49cff; font-size: x-large; text-decoration: underline;">
          <li class="breadcrumb-item">
            <a href="#" style="color: black;">Add Place</a>
          </li>
          ...
          <div class="card-body">
                                  ...
                                  <div class="form-group row">
                                      <label class="col-lg-4 col-form-label" for="remarks">Place Name <span class="text-danger">*</span></label>
                                       <div class="col-lg-6">
                                      <input type="text" name="place_name" id="place_name" class="form-control" placeholder="Enter Place Name" style="background-color: #c0b59aff;" required>
                                       </div>
                                  </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                                <button type="submit" name="sbt-plc" class="btn btn-primary" style="background-color: #846a28ff; border: 1px solid black; margin-left:30%;">Submit</button>
                                            </div>
                                        </div>
