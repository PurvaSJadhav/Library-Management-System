      ...
      <div class="container-fluid" >
        ...
        <ol class="breadcrumb" style="background-color: #ebd49cff; font-size: x-large; text-decoration: underline;">
          <li class="breadcrumb-item">
            <a href="#" style="color: black;">Add Category</a>
          </li>
          
        </ol>

  <div class="card mb-3" style= "width: 90%; margin-left: 5%; background-color: #e9dbb9ff;">
          ...
          <div class="card-body" style="padding-left: 15%">
                                  ...
                                  <div class="form-group row">
                                      <label class="col-lg-4 col-form-label" for="remarks">Category Name <span class="text-danger">*</span></label>
                                       <div class="col-lg-6">
                                      <input type="text" name="category_name" id="category_name" class="form-control" placeholder="Enter Category Name" style="background-color: #c0b59aff;" required>
                                       </div>
                                  </div>
                                      ...
                                      <div class="form-group row">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-lg-8 ml-auto">
                                              <br>
                                                <button type="submit" name="sbt-cat" class="btn btn-primary" style="background-color: #846a28ff; border: 1px solid black; margin-left:30%;">Submit</button>
                                            </div>
                                        </div>
